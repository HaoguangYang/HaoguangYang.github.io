...
|项目|值|
|---|---|
|处理器|Intel® Xeon(R) CPU E3-1245 v5 @ 3.50GHz, 3.90GHz Max × 4 Cores, 8 Threads|
|RAM|32.0 GiB DDR4 双通道|
|GPU|NVidia GeForce GTX TITAN X /PCIe/SSE2; Intel HD Graphics P530|
|操作系统|Ubuntu 16.04.1 LTS amd64|
|硬盘|256 GiB 操作系统盘，2 TB 数据盘|
...
Or use "extra drivers" tab on the software update panel of the system GUI to switch to latest NVIDIA drivers.
...
>       (Optional) Configure the library search path
